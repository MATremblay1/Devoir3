...
plt.plot(xx, yA, label="Régression A", color="green")
plt.plot(xx, yB, label="Régression B", color="red")
plt.xlabel("x")
plt.ylabel("y")
plt.title("Figure 2: Régression linéaire de A et B")
plt.legend()
plt.show()
...
plt.figure()
plt.scatter(x, y, s=3, label="Données")
plt.plot(xx, yy, label="Régression non-linéaire")
plt.xlabel("x")
plt.ylabel("y")
